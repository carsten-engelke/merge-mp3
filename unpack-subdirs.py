...
print ("Use: python unpack-subdirs.py [dir] [filter] [copy-mode] [remove-dir]")
...
print ("    [remove-dir] If 'True', the files are copied into the parent folder. If 'False' they are moved (Use with caution).")
